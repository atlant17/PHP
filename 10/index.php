    ...
    <main>
        <div class="container">
            <div>
                ...
                <br>
                При работе с <i>логическими операторами</i>, наблюдается прямая взаимосвяь с языком <i."JavaScript"</i>, 
                за исключением оператора <strong>"XOR"</strong>, который в языке <strong>"PHP"</strong>, выставляет условие: <i?>одно из значений является 'true'.</i>
            </div>
            <div>
                <div>
                    <p>
